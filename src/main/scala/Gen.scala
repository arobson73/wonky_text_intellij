...
//A.R once sbt is loaded up from root, then type "project answers" . Then type run
//you should then have the option to run this TestGen
object TestGen {

  def main(args: Array[String]) : Unit = {
    //test the &&
    //create a function that tests for positive numbers
    val genString = Gen.stringN(5)
    //show strings
    //println((genString.sample).run)
  }
}
